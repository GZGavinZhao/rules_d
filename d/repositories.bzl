...
_ATTRS = {
    "d_version": attr.string(mandatory = True, values = TOOL_VERSIONS.keys()),
...
def _d_repo_impl(repository_ctx):
    ...
    repository_ctx.download_and_extract(
        url = url,
        integrity = TOOL_VERSIONS[repository_ctx.attr.d_version][repository_ctx.attr.platform],
    )
    build_content = """#Generated by d/repositories.bzl
load("@dev_gzgz_rules_d//d:toolchain.bzl", "d_toolchain")
d_toolchain(name = "d_toolchain", target_tool = select({
